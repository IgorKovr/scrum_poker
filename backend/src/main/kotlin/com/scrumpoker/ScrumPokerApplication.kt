 ...
 * 
 * This file contains the main application class and startup configuration for the
 * Scrum Poker backend service. It sets up the Spring Boot application with
 ...
 * 3. Scheduling enablement for heartbeat and monitoring services
 * 
 ...
 * On startup, the application displays comprehensive system information including
 * memory usage, JVM details, and available endpoints for debugging and monitoring.
 */
 ...
 * 
 * This class serves as the entry point for the Scrum Poker backend application.
 * It uses Spring Boot annotations to configure the application automatically.
 * 
 * Annotations:
 * - @SpringBootApplication: Enables auto-configuration, component scanning, and configuration
 * - @EnableScheduling: Allows the use of @Scheduled annotations for periodic tasks
 * 
 * The application automatically scans for components in the com.scrumpoker package
 * and sets up all necessary beans for dependency injection.
 */
 ...
 * 
 * This function starts the Spring Boot application using the standard
 * runApplication helper function. It passes command line arguments to
 * the application for configuration flexibility.
 * 
 ...
 * 
 * This component listens for the ApplicationReadyEvent and displays detailed
 * system information when the application has fully started. This provides
 * valuable debugging information and confirms the application is ready to
 * accept connections.
 * 
...
class StartupListener {
     ...
     * 
     * This method is called when the Spring Boot application has fully started
     * and is ready to accept requests. It displays comprehensive system information
