  ...
  return (
    <button
      ...
      className={`
        ...
        ${
          isSelected
            ? "bg-blue-600 dark:bg-blue-700 text-white shadow-lg transform -translate-y-1"
            : "bg-white dark:bg-dark-surface text-gray-800 dark:text-dark-text hover:bg-gray-50 dark:hover:bg-gray-600 shadow-md hover:shadow-lg"
        }
        border-2 ${
          isSelected
